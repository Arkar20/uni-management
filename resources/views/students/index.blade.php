...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="{{asset('student/assets/vendor/animate.css/animate.min.css')}}" rel="stylesheet">
  ...
  <link href="{{asset('student/assets/vendor/remixicon/remixicon.css')}}" rel="stylesheet">
        ...
        <div class="row">
                @forelse ($sections as $section)
                    <div class="col-lg-3 col-md-6">
                            ...
                            <ul>
                                <li>{{$section->section_start_date}}</li>
                                <li>{{$section->section_end_date}}</li>
