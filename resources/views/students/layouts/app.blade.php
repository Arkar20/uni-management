...
<head>
    ...
    <link rel="apple-touch-icon" href="{{asset('student/assets/img/apple-icon.png')}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('student/assets/img/favicon.ico')}}">
    <!-- Load Require CSS -->
